...
class TargetMovementPredictor:
    ...
    def predict_out_of_view(self, target_data, target_id, last_seen_time, prediction_duration,
        ...
        for _, row in history_df.iterrows():
            # Base features: x, y, altitude (3 features)
...
if __name__ == "__main__":
    ...
    config = {
        ...
        'learning_rate': 1e-4,
        'batch_size': 32,
        'num_epochs': 2,  # Reduce for faster training during development
        'sequence_length': 10,
        'prediction_horizon': 5,
        'terrain_feature_dim': 32,
        'use_terrain': True,
